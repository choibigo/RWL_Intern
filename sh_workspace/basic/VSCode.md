...
![git_add판별](../images/A_U.png)

### 1. +를 누르면 git add가 된다.

![git add](../images/git_add.png)

### 2. commit messegae를 작성하고 commit을 누르면 git commit -m ""가 실행된다.

![git commit -m ](../images/git_commit.png)

### 3. push를 누르면 git push origin main이 실행된다.

![git push origin main](../images/git_push_origin_main.png)
