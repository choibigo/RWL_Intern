...
<img src="images/dl_resnet_image-2.png" width="600">

<img src="images/dl_resnet_image-3.png" width="600">

<img src="images/dl_resnet_image-4.png" width="600">

<img src="images/dl_resnet_image-5.png" width="600">

<img src="images/dl_resnet_image-6.png" width="600">

<img src="images/dl_resnet_image-7.png" width="600">

<img src="images/dl_resnet_image-8.png" width="600">

<img src="images/dl_resnet_image-9.png" width="600">
...
- ResNet 논문을 읽으면 Vanishing 문제는 이미 초깃값 및 배치 정규화로 어느 정도 해결 된것으로 보고 있으며.
    - 그들이 해결하려는 것은 모델이 깊어지고 커짐에 따라 오히려 성능이 이상하게 떨어지는 **degradation problem**을 해결하는 것이었다.

> Degradation 문제는 Bias Variance 문제와 **다르다**!! Bias Variance는 모델이 깊어짐에 따라 train에 대한 에러는 **내려**가지만, val에 대한 에러가 올라가는 문제고. **Degradation**은 모델이 깊어짐에 따라 train, val에 대한 **에러가 둘다 그냥 증가**하는거임!!
...
- 인풋이 x인 신경의 아웃풋을 H(x)라고 해보자. 신경망을 최대한 **함수처럼 생각**하는 것이다.
...
<img src="images/dl_resnet_image-1.png" width="600">
...
- 이론상으로 차이가 있다! 신경망 입장에서 **이 추측이 더 쉬운** 것이다!
    ...
    - 그리고 최소 기준점이 있으니 모델이 학습하기가 더 쉬워지는 것!

- 이 F(x)를 **Residual Function**이라고 부르고.
    - 이 모델은 이를 적극적으로 사용했기에 **Residual Network**, 즉 **ResNet**으로 불리는 것이다.
...
<img src="images/unet_image.png" width="600">
...
<img src="images/unet_image-1.png" width="600">
...
<img src="images/unet_image-4.png" width="600">

별거 없고 말그대로 **Encoder 피쳐맵를 Decoder에 갖다 붙임**. Decoder 흰색 부분이 갖다 붙여진 부분.

**Encoder**는 **자잘한 특징**들이 담겨있음, 모서리와 선분, 실제 물체 등이 있음. <- **공간**에 대해 잘 안다.

**Decoder**는 그 반면에 그 물체가 뭔지 같은 더 **고차원의 이야기**를 하는거임. <- **개념**적인 것을 잘 안다.

위 둘을 합쳐서 **공간**과 **개념**을 **둘다** 챙겨가는 것. 즉 개념도 알고, 그게 어디있는지도 비교적 정확히 아는거다.

- 가운데 과정 **bottleneck**

<img src="images/unet_image-6.png" width="450">
...
<img src="images/unet_image-5.png" width="600">
